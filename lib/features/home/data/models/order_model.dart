...
class OrderModel {
  ...
  factory OrderModel.fromMap(Map<String, dynamic> map) => OrderModel(
    ...
    paymentAmount: (map['payment_amount'] as num?)?.toInt() ?? 0,
    ...
    totalItem: (map['total_item'] as num?)?.toInt() ?? 0,
    idKasir: (map['id_kasir'] as num?)?.toInt() ?? 0,
    namaKasir: map['nama_kasir']?.toString() ?? '',
    transactionTime: map['transaction_time']?.toString() ?? '',
